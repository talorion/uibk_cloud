...
protected:
  ...
  virtual void mouseDoubleClickEvent(QMouseEvent *evt) {Q_UNUSED(evt)}
  virtual void wheelEvent(QWheelEvent *evt) {Q_UNUSED(evt)}
...
public:
  ...
  */
  ...
  void clear();
  bool contains(QCPBars *brs) const { return mBars.contains(brs); }
